...
public final class MaterialMetaData implements Parcelable {
    ...
    public String toString() {
        return String.format("[%d,%d,%s,%d]", _id, cid, name, downloaded);
    }

    protected MaterialMetaData(Parcel in) {
        cid = in.readInt();
        name = in.readString();
    ...
    public static final Creator<MaterialMetaData> CREATOR = new Creator<MaterialMetaData>() {
        @Override
